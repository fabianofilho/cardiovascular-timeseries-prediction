...
Table~\ref{tab:desempenho} reports accuracy for all five models. With a mean of roughly
7{,}250 deaths per month, the best MAE corresponds to a relative error near 4.9\%.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{fig2_smape_ic.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{fig4_janela.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{fig3_horizonte.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{fig6_temperatura.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{fig5_sazonal.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.94\textwidth]{fig1_serie.pdf}
