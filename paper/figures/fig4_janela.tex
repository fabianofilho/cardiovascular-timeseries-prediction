...
\addplot[only marks, mark=square*, mark size=2.0pt, draw=csarima, fill=csarima] coordinates {(5.3909,5)};
...
\addplot[only marks, mark=square*, mark size=2.0pt, draw=csarima, fill=csarima] coordinates {(5.4588,4)};
...
\addplot[only marks, mark=square*, mark size=2.0pt, draw=csarima, fill=csarima] coordinates {(4.7447,3)};
...
\addplot[only marks, mark=square*, mark size=2.0pt, draw=csarima, fill=csarima] coordinates {(6.6424,2)};
...
\addplot[only marks, mark=square*, mark size=2.0pt, draw=csarima, fill=csarima] coordinates {(6.8657,1)};
\node[anchor=west, font=\scriptsize, text=black] at (axis cs:7.0350,1) {-0.07 pp};
