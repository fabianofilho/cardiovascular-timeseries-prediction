...
\addplot[only marks, mark=square*, mark size=2.4pt, draw=cxgboost, fill=cxgboost] coordinates {(6.8324,3)};
\addplot[only marks, mark=*, mark size=2.4pt, draw=cxgboost, fill=cxgboost] coordinates {(7.0649,2)};
\addplot[only marks, mark=triangle*, mark size=2.4pt, draw=cxgboost, fill=cxgboost] coordinates {(6.2244,1)};
