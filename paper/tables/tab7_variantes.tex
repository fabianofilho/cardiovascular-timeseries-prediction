...
\midrule
Lags only (as reported) & 6.59 & 1.213 & 6.83 & 1.254 & $[-0.06, +0.72]$ & 0/6 \\
+ rolling window statistics & 6.79 & 1.248 & 6.98 & 1.281 & $[+0.16, +0.90]$ & 0/6 \\
+ Fourier calendar terms & 6.27 & 1.150 & 6.66 & 1.223 & $[-0.37, +0.39]$ & 0/6 \\
Seasonal differencing & 6.20 & 1.142 & 6.28 & 1.154 & $[-0.37, +0.23]$ & 0/6 \\
Differencing + windows + calendar & 6.14 & 1.129 & 6.43 & 1.180 & $[-0.43, +0.14]$ & 0/6 \\
