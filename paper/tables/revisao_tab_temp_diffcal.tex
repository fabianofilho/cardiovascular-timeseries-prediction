...
\midrule
XGBoost, lags only & 6.83 & 6.59 & $+0.238$ \\
XGBoost, + calendar and seasonal difference & 6.35 & 6.42 & $-0.074$ \\
\bottomrule
\end{tabular}
...
the covariate. The gain shrinks in both models, CatBoost from $+0.258$ to $+0.076$ and XGBoost from $+0.238$ to $-0.074$ percentage
