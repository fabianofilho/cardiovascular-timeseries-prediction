...
\usepackage{caption}
\usepackage{amsmath}
% A legenda da fig4_janela usa \blacksquare, que vem daqui. Sem amssymb o
% documento inteiro para de compilar, ainda que a figura isolada compile: o
% preambulo que o gerador monta para compilar cada figura sozinha ja o carrega.
\usepackage{amssymb}
